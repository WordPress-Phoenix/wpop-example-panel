...
class Network_Options_Panel {
	 ...
	 */
	function setup_network_options() {
	...
	function network_options_config() {
		return array(
			'parent_page_id' => 'settings.php',
			'id'             => 'wpop-example-network',
			'page_title'     => 'WPOP Network Panel Settings',
			'menu_title'     => 'WPOP Network Panel',
